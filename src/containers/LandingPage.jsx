...
const LandingPage = () => {
  const handleClick = () => {
    ...
    // You can add any additional logic or navigate to a different route
  ...
  return (
    <div>
      <section id="landing" className="landing-section">
        <h1 className="landing-title">Strange Medicine</h1>
        <ul className="side-effects-list">
          <li id="titleL">Side Effects May Include:</li> 
          <li>Intense Euphoria</li>
          <li>Hearing and Vision Hallucinations</li>
          <li>Increased Energy and Pleasure</li>
          <li>Distorted Sensory and Time Perception</li>
        </ul>

        <Link to="https://strangemedicineofficial.onrender.com/Home" className="link link--alt" onClick={handleClick}>
          <svg viewBox='0 0 200 200' width='200' height='200' xmlns='http://www.w3.org/2000/svg' className="link__svg" aria-labelledby="link2-title link2-desc">
            <title id="link2-title">I've Consulted With My Doctor</title>
